...
- added possibility to exclude user accounts from specified OU
...
- fixed `bodyAsHtml` config element processing.

## [1.8.2] 2025-11-19

### Fixed

- fixed e-mail body interpretation, when it is enclosed in CDATA section

## [1.8.1] 2025-11-19

### Fixed

- when using manager mail, don't require e-mail address on user when searching

## [1.8.0] 2025-11-19

### Added

- config parameters to mark message priority and HTML body.
